...
<%	int i=0;
    try {
    	String query="select * from f_signup f inner join professionaldetails p on f.jsid=p.jsid inner join resume r on p.jsid=r.jsid inner join personaldetails pd on r.jsid=pd.jsid";
