...
ArrayList<String> emailid=new ArrayList<String>();
    try {
    	...
    	String query="select * from (select * from f_signup f inner join professionaldetails p on f.jsid=p.jsid inner join resume r on p.jsid=r.jsid inner join personaldetails pd on r.jsid=pd.jsid) where tenth > ? and twelth > ? and graduation >?";
...
<empty>
						...
						<tr><td>Sender:</td><td><input type="text" name="sender" size="25" value="${email }" readonly="readonly" required="required"/></td>>
